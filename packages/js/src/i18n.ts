const messages = {
  ko: {
    ...
    pay_with_metamask: 'MetaMask로 결제',
    pay_with_walletconnect: 'WalletConnect',
    pay_with_coinbase: 'Coinbase Wallet로 결제',
    pay_with_phantom: 'Phantom으로 결제',
    metamask_desc: '브라우저 지갑',
    walletconnect_desc: '모바일 지갑 연결',
    walletconnect_coming_soon: '준비 중',
    coinbase_desc: 'Coinbase 지갑',
  ...
  en: {
    ...
    pay_with_walletconnect: 'WalletConnect',
    pay_with_coinbase: 'Pay with Coinbase',
    pay_with_phantom: 'Pay with Phantom',
    metamask_desc: 'Browser Wallet',
    walletconnect_desc: 'Mobile Wallet',
    walletconnect_coming_soon: 'Coming Soon',
    coinbase_desc: 'Coinbase Wallet',
